...
export default function FranchiseDashboard() {
  ...
  const fetchDashboardData = async (year) => {
    setLoading(true);
    try {
      console.log(`Fetching franchise dashboard data for year ${year}...`);
      
      const response = await axiosInstance.get(`/api/franchise/dashboard/?year=${year}`);
    ...
    if (dashboardData) {
      ...
      const animate = () => {
        ...
        setAnimatedValues({
          ...
          myGrowtagsCount: Math.floor(progress * (dashboardData.cards?.my_growtags_count || 0)),
          totalRevenue: Math.floor(progress * (dashboardData.cards?.total_earnings || 0)),
          ...
          workAssignedToGrowtag: Math.floor(progress * (dashboardData.cards?.work_assigned_to_growtag || 0)),
  ...
  const revenueChart = {
    labels: dashboardData?.charts?.revenue_growth?.labels || 
            ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    datasets: [
      {
        label: "Revenue (₹)",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">
                Welcome back, <span className="text-blue-600 animate-gradient bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  {dashboardData?.shop?.name || user?.name || "Franchise"}
                </span>
              </h1>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              ...
              style={{ 
                width: dashboardData?.cards?.total_assigned_complaints > 0 ? '82%' : '0%',
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              ...
              style={{ 
                width: dashboardData?.cards?.todays_complaints > 0 ? '72%' : '0%',
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="text-sm font-medium text-purple-600 bg-purple-50 px-3 py-1 rounded-full animate-bounce-in">
              {animatedValues.myGrowtagsCount} Active
            </span>
          </div>
          ...
          <div className="flex items-end justify-between">
            <p className="text-3xl font-bold text-purple-600 font-mono animate-count-up">
              {animatedValues.myGrowtagsCount}
            </p>
          </div>
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              ...
              style={{ 
                width: dashboardData?.cards?.my_growtags_count > 0 ? '75%' : '0%',
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              ...
              style={{ 
                width: dashboardData?.cards?.total_earnings > 0 ? '68%' : '0%',
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-teal-500 to-teal-600 rounded-full animate-progress"
              style={{ 
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-orange-500 to-orange-600 rounded-full animate-progress"
              style={{ 
                width: dashboardData?.cards?.pending_work > 0 ? '27%' : '0%',
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-slide-up"
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="text-sm font-medium text-red-600 bg-red-50 px-3 py-1 rounded-full animate-bounce-in">
              Assigned
            </span>
          </div>
          <h3 className="text-gray-500 text-sm font-medium mb-2">Work Assigned to GrowTag</h3>
          <div className="flex items-end justify-between">
            <p className="text-3xl font-bold text-red-600 font-mono animate-count-up">
              {animatedValues.workAssignedToGrowtag}
            </p>
          </div>
          <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-red-500 to-red-600 rounded-full animate-progress"
              style={{ 
                width: dashboardData?.cards?.work_assigned_to_growtag > 0 ? '46%' : '0%',
